                ...
                <div class="modal-content">
                    ...
                    <form id="userCreateEditFormPermission" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="permission">Cho phép</label>:
                                 @foreach($permissions as $permission)
                                    <div class="checkbox">
                                      <label>
                                        <input type="checkbox" value="{{$permission->id}}" name="permissions[]" class="checkbox-role" id="permission{{$permission->id}}">
                                        {{$permission->name}}
                                      </label>
                                    </div>
                                 @endforeach
