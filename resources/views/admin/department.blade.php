            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Xem khoa</h4>
                    </div>
                    ...
                    <form id="userCreateEditForm">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea value="{{ old('description') }}" name="description" class="form-control" placeholder="" id="description"></textarea>
        ...
        $(document).ready(function() {
            ...
            var userList = $('#userList').DataTable({
                ...
                language: {
                    ...
                    "info":           "Tổng: _TOTAL_ khoa.",
                    "infoEmpty":      "Tổng: 0 khoa",
                    "infoThousands":  ".",
                    "lengthMenu":     "Hiện _MENU_ khoa",
                    "loadingRecords": "Đang tải...",
                    "processing":     "Đang xử lý...",
                    "search":         "Tìm nhanh:",
                    "searchPlaceholder": "Điền từ khóa...",
                    "zeroRecords":    "Không tìm thấy khoa nào thỏa mãn.",
                    "paginate": {
                        "sFirst":    "Đầu",
                        "sLast":     "Cuối",
                        "sNext":     "Sau",
                    ...
                    "infoFiltered":   "(Tìm kiếm từ _MAX_ khoa)",
                    select: {
                        rows: "",
                        rows: "Đã chọn: %d khoa."
                    }
                ...
                buttons: [
                    {
                        ...
                        action: function (e) {
                            ...
                            $('#userCreateEditModalTitle').text("Thêm khoa");
                    ...
                    },
                    {
                        extend: 'pageLength',
                        text: 'Trên một trang',
                        titleAttr: 'Hiện số khoa trên một trang'
                    },
                    {
                        extend: 'colvis',
                        text: 'Hiện',
            ...
            var userUrl = baseUrl+"/department";
