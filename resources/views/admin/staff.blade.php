        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Xem nhân viên</h4>
                </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        <div class="text-center">
                            <p>Xác nhận xóa (các) nhân viên này?</p>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="chucvu" id='chucvu'>
                                <?php
                                $office = DB::table('user_office')->where('position_id', 3)->get();
                        ...
                        <div class = "form-group">
                            <label>Học vị</label>
                            <select class="form-control"  name="bangcap" id='bangcap'>
                                <?php
                                $degree = DB::table('user_degree')->get();
    ...
    $(document).ready(function () {
        ...
        var userList = $('#userList').DataTable({
            ...
            language: {
                ...
                "info": "Tổng: _TOTAL_ nhân viên.",
                "infoEmpty": "Tổng: 0 nhân viên",
                "infoThousands": ".",
                "lengthMenu": "Hiện _MENU_ nhân viên",
                "loadingRecords": "Đang tải...",
                "processing": "Đang xử lý...",
                "search": "Tìm nhanh:",
                "searchPlaceholder": "Điền từ khóa...",
                "zeroRecords": "Không tìm thấy nhân viên nào thỏa mãn.",
                "paginate": {
                    "sFirst": "Đầu",
                    "sLast": "Cuối",
                    "sNext": "Sau",
                ...
                "infoFiltered": "(Tìm kiếm từ _MAX_ nhân viên)",
                select: {
                    rows: "",
                    rows: "Đã chọn: %d nhân viên."
                }
            },
            buttons: [
                {
                    text: 'Thêm',
                    titleAttr: 'Thêm nhân viên',
                    action: function (e) {
                        e.preventDefault();
                        $('#userAlert').empty();
                        $('#btn-save-user').val("add");
                        $('#btn-save-user').addClass('bg-purple');
                        $('#userCreateEditModalTitle').text("Thêm nhân viên");
                ...
                },
                {
                    extend: 'pageLength',
                    text: 'Trên một trang',
                    titleAttr: 'Hiện số nhân viên trên một trang'
                },
                {
                    extend: 'colvis',
                    text: 'Hiện',
        ...
        $('#userList tbody').on('click', '.open-edit-user-modal', function () {
            ...
            $.get(userUrl + '/edit/' + user_id, function (data) {
                ...
                $('#userCreateEditModalTitle').text("Sửa nhân viên");
