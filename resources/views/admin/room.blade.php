        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Xem phòng</h4>
                </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            ...
            <div class="modal-content">
                ...
                <form>
                    <div class="modal-body">
                        <div class="text-center">
                            <p>Xác nhận xóa (các) phòng này?</p>
    ...
    $(document).ready(function () {
        ...
        var userList = $('#userList').DataTable({
            ...
            language: {
                ...
                "info": "Tổng: _TOTAL_ room.",
                "infoEmpty": "Tổng: 0 room",
                "infoThousands": ".",
                "lengthMenu": "Hiện _MENU_ room",
                "loadingRecords": "Đang tải...",
                "processing": "Đang xử lý...",
                "search": "Tìm nhanh:",
                "searchPlaceholder": "Điền từ khóa...",
                "zeroRecords": "Không tìm thấy room nào thỏa mãn.",
                "paginate": {
                    "sFirst": "Đầu",
                    "sLast": "Cuối",
                    "sNext": "Sau",
                ...
                "infoFiltered": "(Tìm kiếm từ _MAX_ room)",
                select: {
                    rows: "",
                    rows: "Đã chọn: %d room."
                }
            ...
            buttons: [
                {
                    text: 'Thêm',
                    titleAttr: 'Thêm phòng',
                    action: function (e) {
                        e.preventDefault();
                        $('#userAlert').empty();
                        $('#btn-save-user').val("add");
                        $('#btn-save-user').addClass('bg-purple');
                        $('#userCreateEditModalTitle').text("Thêm phòng");
                ...
                },
                {
                    extend: 'pageLength',
                    text: 'Trên một trang',
                    titleAttr: 'Hiện số phòng trên một trang'
                },
                {
                    extend: 'colvis',
                    text: 'Hiện',
