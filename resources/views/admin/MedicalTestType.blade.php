        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Xem loại xét nghiệm</h4>
                </div>
    ...
    <div class="modal fade" id="userDeleteModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Đóng"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Xóa loại xét nghiệm</h4>
                </div>
                <form>
                    <div class="modal-body">
                        <div class="text-center">
                            <p>Xác nhận xóa (các) loại xét nghiệm này?</p>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var userList = $('#userList').DataTable({
            ajax: baseUrl + "/listMedicalTestType",
            columns: [
                {
                    "visible": true,
                    "searchable": false,
            ...
            language: {
                ...
                "info": "Tổng: _TOTAL_ loaixetnghiem.",
                "infoEmpty": "Tổng: 0 loaixetnghiem",
                "infoThousands": ".",
                "lengthMenu": "Hiện _MENU_ loaixetnghiem",
                "loadingRecords": "Đang tải...",
                "processing": "Đang xử lý...",
                "search": "Tìm nhanh:",
                "searchPlaceholder": "Điền từ khóa...",
                "zeroRecords": "Không tìm thấy loại xét nghiệm nào thỏa mãn.",
                "paginate": {
                    "sFirst": "Đầu",
                    "sLast": "Cuối",
                    "sNext": "Sau",
                ...
                "infoFiltered": "(Tìm kiếm từ _MAX_ loaixetnghiem)",
                select: {
                    rows: "",
                    rows: "Đã chọn: %d loaixetnghiem."
                }
            },
            buttons: [
                {
                    text: 'Thêm',
                    titleAttr: 'Thêm loại xét nghiệm',
                    action: function (e) {
                        e.preventDefault();
                        $('#userAlert').empty();
                        $('#btn-save-user').val("add");
                        $('#btn-save-user').addClass('bg-purple');
                        $('#userCreateEditModalTitle').text("Thêm loại xét nghiệm");
                ...
                },
                {
                    ...
                    title: 'Danh sách loại xét nghiệm',
                ...
                },
                {
                    extend: 'pageLength',
                    text: 'Trên một trang',
                    titleAttr: 'Hiện số loại xét nghiệm trên một trang'
                },
                {
                    extend: 'colvis',
                    text: 'Hiện',
        ...
        var userUrl = baseUrl + "/MedicalTestType";
