            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Xem học vị</h4>
                    </div>
        ...
        <div class="modal fade" id="userDeleteModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Đóng"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Xóa học vị</h4>
                    </div>
                    <form>
                        <div class="modal-body">
                            <div class="text-center">
                                <p>Xác nhận xóa (các) học vị này?</p>
        ...
        $(document).ready(function() {
            ...
            var userList = $('#userList').DataTable({
                ...
                language: {
                    ...
                    "info":           "Tổng: _TOTAL_ hocvi.",
                    "infoEmpty":      "Tổng: 0 hocvi",
                    "infoThousands":  ".",
                    "lengthMenu":     "Hiện _MENU_ hocvi",
                    "loadingRecords": "Đang tải...",
                    "processing":     "Đang xử lý...",
                    "search":         "Tìm nhanh:",
                    "searchPlaceholder": "Điền từ khóa...",
                    "zeroRecords":    "Không tìm thấy hocvi nào thỏa mãn.",
                    "paginate": {
                        "sFirst":    "Đầu",
                        "sLast":     "Cuối",
                        "sNext":     "Sau",
                    ...
                    "infoFiltered":   "(Tìm kiếm từ _MAX_ hocvi)",
                    select: {
                        rows: "",
                        rows: "Đã chọn: %d hocvi."
                    }
                },
                buttons: [
                    {
                        text: 'Thêm',
                        titleAttr: 'Thêm học vị',
                        action: function (e) {
                            e.preventDefault();
                            $('#userAlert').empty();
                            $('#btn-save-user').val("add");
                            $('#btn-save-user').addClass('bg-purple');
                            $('#userCreateEditModalTitle').text("Thêm học vị");
                    ...
                    },
                    {
                        extend: 'pageLength',
                        text: 'Trên một trang',
                        titleAttr: 'Hiện số học vị trên một trang'
                    },
                    {
                        extend: 'colvis',
                        text: 'Hiện',
