            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        ...
                        <div class='row'>
                            <div class="col-lg-4" align="right"><strong>Chức vụ</strong>   :</div>
                            <div id="user_chucvu" class="col-lg-8" align="left"></div>
                        </div>
                        <div class='row'>
                            <div class="col-lg-4" align="right"><strong>Bằng cấp</strong>   :</div>
                            <div id="user_bangcap" class="col-lg-8" align="left"></div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="chucvu" id='chucvu'>
                                <?php
                                $office = DB::table('user_office')->where('position_id', 2)->get();
    ...
    $(document).ready(function () {
        ...
        $('#userList tbody').on('click', '.open-view-user-modal', function () {
            ...
            $.get(userUrl + '/show/' + user_id, function (data) {
                ...
                $('#user_chucvu').html(data.chucvu);
                $('#user_bangcap').html(data.bangcap);
