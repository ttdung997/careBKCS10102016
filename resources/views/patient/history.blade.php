...
<div class="row">
    <div class="col-md-12">
        ...
        <table id="table" data-toggle="table"
               data-url="{{ route('wait-history-json') }}">
            <thead>
                <tr>
    ...
    <div class="col-md-12">
        <h1>Lịch sử khám chuyên khoa</h1>
        <table id="table" data-toggle="table"
               data-url="{{ route('wait-history-specialist-json') }}">
            <thead>
                <tr>
    ...
    <div class="col-md-12">
        ...
        <table id="table" data-toggle="table"
               data-url="{{ route('wait-history-test-json') }}">
            <thead>
                <tr>

                    <th data-field="name">Tên loại xét nghiệm</th>
                    <th data-field="medical_date"
                        data-formatter="dateFormatter">Ngày khám</th>
                    <th data-field="status" data-formatter="statusFormatter">Trạng thái</th>
                    <th data-field="id"
